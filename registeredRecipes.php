...
<div class="container">
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="allRecipes.php">Categorías</a></li>
                        ...
                        <div class="card shadow p-0.5 mb-5 bg-body rounded " >
                            <img src="./imgs/ice-cream.jpg" class="rounded float-start card-img-top" alt="food"> 
                             <div class="card-body">
                              ...
                              <h6><a class="card-subtitle" href="recipeDetails.php">Bora Ice Cream</a></h6>
                  ...
                  <div class="p-2 ">
                       <div class="card shadow p-0.5 mb-5 bg-body rounded" >
                           <img src="./imgs/menu-5.jpg" class="rounded float-start  card-img-top" alt="food"> 
                            <div class="card-body">
                              <span class="badge rounded-pill text-bg-info mb-2">Postre</span>
                              <h6><a class="card-subtitle" href="recipeDetails.php">Suga Cake</a></h6>
                                <a href="#" class="btn btn-card">Votar</a>
                  ...
                  <div class="p-2 ">
                       <div class="card shadow p-0.5 mb-5 bg-body rounded" >
                           <img src="./imgs/menu-3.jpg" class="rounded float-start  card-img-top" alt="food"> 
                            <div class="card-body">
                              <span class="badge rounded-pill text-bg-info mb-2">Postre</span>
                              <h6><a class="card-subtitle" href="recipeDetails.php">RMs Hotteoks</a></h6>
                                <a href="#" class="btn btn-card">Votar</a>
                  ...
                  <div class="p-2 ">
                       <div class="card shadow p-0.5 mb-5 bg-body rounded" >
                           <img src="./imgs/menu-4.jpg" class="rounded float-start  card-img-top" alt="food"> 
                            <div class="card-body">
                              <span class="badge rounded-pill text-bg-info mb-2">Postre</span>
                              <h6><a class="card-subtitle" href="recipeDetails.php">Hopes Croffle</a></h6>
                                <a href="#" class="btn btn-card">Votar</a>
